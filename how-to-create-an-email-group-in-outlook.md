...
<div class="card border-0 shadow-sm my-4">
  <div class="card-body">
    ...
    <p class="card-text text-muted mb-3">MailMouse gives your group one address that anyone can email — no admin center, no per-person copies. Members are plain email addresses on any provider: Outlook, Gmail, company mail, anything. Add or remove people in seconds from one dashboard.</p>
...
A contact group (contact list) lives in your personal contacts — it's a private shortcut only you can use. A distribution list is a real, org-wide email address managed centrally in Microsoft 365 or Exchange: anyone can send to it, and every member receives the message. See our comparison of [shared addresses and group email options](/google-groups-alternative/) for the bigger picture.
...
Same concept, different names — Gmail uses contact *labels* and Google Groups. Step-by-step instructions are in our guide to [creating a group email in Gmail](/how-to-create-a-group-email-in-gmail/).
